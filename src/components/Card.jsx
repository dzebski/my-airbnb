    ...
    return (
        <div className="card">
            <div className="card__img">
                ...
                {badgeText && <div className="card__img--label">{badgeText}</div>}
            </div>
            <div className="card__body">
                <div className="card__body--ratings">
                    ...
                    <span className='rating'>{props.item.stats.rating.toFixed(1)}</span>
                    <span className='totalReviews'>({props.item.stats.reviewCount})</span>
                ...
                <div className="card__body--price">
                    <span className='bold'>From ${props.item.price}</span><span> / person</span>
                </div>
            </div>
        </div>
    )
